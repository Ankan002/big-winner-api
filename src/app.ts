...
import { dailyWinJackpotRouter, dailyWinMegaJackpotRouter, colorGameRouter, practiceGameRouter } from "routes/game";
...
export const startServer = async () => {
	...
	app.use("/api/game/color-game", colorGameRouter);
	app.use("/api/game/practice", practiceGameRouter);
